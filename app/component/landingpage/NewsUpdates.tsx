		...
		<section className="w-full px-4 sm:px-6 lg:px-16 mt-16 overflow-hidden">
			...
			{isLoading || newsItems.length === 0 ? (
				<div className="flex justify-center items-center h-64">
					...
					<span className="ml-3 text-gray-600">
						{newsItems.length === 0 ? 'Loading latest Ghana news...' : 'Refreshing news...'}
					</span>
				</div>
			) : (
			...
			<div className="mt-8 text-center">
				...
				<p className="text-xs text-gray-500">
					Real-time updates from Ghana&apos;s leading television stations about illegal mining and environmental protection
				</p>
			</div>
